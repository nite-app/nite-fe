...
function Appearance() {
  const [lightSelected, setLightSelected] = useState(
    "rounded-lg border-blue-600 border-4"
  );
  const [darkSelected, setDarkSelected] = useState(
    "rounded-lg border-white border-4"
  );
        ...
        <div className="flex">
          <div className="mr-4">
            <img
              ...
              onClick={() => {
                setLightSelected("rounded-lg border-blue-600 border-4");
                setDarkSelected("rounded-lg border-white border-4");
          ...
          <div className="">
            <img
              ...
              onClick={() => {
                setLightSelected("rounded-lg border-white border-4");
                setDarkSelected("rounded-lg border-blue-600 border-4");
                setLightText("Light");
                setDarkText("✔️ Dark");
              }}
            />
